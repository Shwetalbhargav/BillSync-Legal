...
const FirmSchema = new mongoose.Schema(
  {
    ...
    nextInvoiceSequence: { type: Number, default: 1, min: 1 },
    receiptPrefix: { type: String, trim: true, uppercase: true, default: 'RCT' },
    nextReceiptSequence: { type: Number, default: 1, min: 1 },
