...
export const CORE_FEATURES = [
  ...
  {
    key: 'ai.dashboard_assist',
    name: 'Dashboard AI',
    category: 'ai',
    status: 'active',
    gateBehavior: 'disable',
    usageMetric: 'ai_credits',
    unavailableMessage: 'Dashboard AI is not included in the current plan.',
  },
  {
    key: 'ai.client_assist',
    name: 'Client AI',
    category: 'ai',
    status: 'active',
    gateBehavior: 'disable',
    usageMetric: 'ai_credits',
    unavailableMessage: 'Client AI is not included in the current plan.',
  },
  {
    key: 'ai.matter_assist',
    name: 'Matter AI',
    category: 'ai',
    status: 'active',
    gateBehavior: 'disable',
    usageMetric: 'ai_credits',
    unavailableMessage: 'Matter AI is not included in the current plan.',
  },
  {
    key: 'ai.invoice_assist',
    name: 'Invoice AI',
    category: 'ai',
    status: 'active',
    gateBehavior: 'disable',
    usageMetric: 'ai_credits',
    unavailableMessage: 'Invoice AI is not included in the current plan.',
  },
  {
    key: 'ai.document_assist',
    name: 'Document AI',
    category: 'ai',
    status: 'active',
    gateBehavior: 'disable',
    usageMetric: 'ai_credits',
    unavailableMessage: 'Document AI is not included in the current plan.',
  },
  {
    key: 'ai.court_assist',
    name: 'Court AI',
    ...
    gateBehavior: 'disable',
    usageMetric: 'ai_credits',
    unavailableMessage: 'Court AI is not included in the current plan.',
  },
  {
    key: 'ai.research_assist',
    name: 'Research AI',
    category: 'ai',
    status: 'active',
    gateBehavior: 'disable',
    usageMetric: 'ai_credits',
    unavailableMessage: 'Research AI is not included in the current plan.',
  },
  {
    key: 'ai.matter_qna',
    name: 'Matter Q&A',
...
export const CORE_PERMISSIONS = [
  ...
  { key: 'client.delete', name: 'Delete clients', moduleKey: 'clients', action: 'delete', resource: 'client' },
  ...
  { key: 'matter.read', name: 'View matters', moduleKey: 'matters', action: 'read', resource: 'matter' },
  { key: 'matter.create', name: 'Create matters', moduleKey: 'matters', action: 'create', resource: 'matter' },
  { key: 'matter.edit', name: 'Edit matters', moduleKey: 'matters', action: 'edit', resource: 'matter' },
  { key: 'matter.assign', name: 'Assign matter teams', moduleKey: 'matters', action: 'assign', resource: 'matter' },
  ...
  { key: 'payment.record', name: 'Record payments', moduleKey: 'finance', action: 'record', resource: 'payment' },
  ...
  { key: 'ai.use', name: 'Use AI', moduleKey: 'ai', action: 'use', resource: 'ai' },
  { key: 'ai.client', name: 'Use client AI', moduleKey: 'ai', action: 'assist', resource: 'client_ai' },
  { key: 'ai.matter', name: 'Use matter AI', moduleKey: 'ai', action: 'assist', resource: 'matter_ai' },
  { key: 'ai.invoice', name: 'Use invoice AI', moduleKey: 'ai', action: 'assist', resource: 'invoice_ai' },
  { key: 'ai.document', name: 'Use document AI', moduleKey: 'ai', action: 'assist', resource: 'document_ai' },
  { key: 'ai.court', name: 'Use court AI', moduleKey: 'ai', action: 'assist', resource: 'court_ai' },
  { key: 'ai.research', name: 'Use research AI', moduleKey: 'ai', action: 'assist', resource: 'research_ai' },
  { key: 'ai.dashboard', name: 'Use dashboard AI', moduleKey: 'ai', action: 'assist', resource: 'dashboard_ai' },
  { key: 'ai.manage', name: 'Manage AI settings', moduleKey: 'ai', action: 'manage', resource: 'ai' },
];
...
export const CORE_ROLES = [
  ...
  },
  {
    ...
    name: 'Lawyer',
    status: 'active',
    permissionKeys: ['workspace.read', 'client.read', 'client.create', 'client.edit', 'client.delete', 'clients.read', 'clients.write', 'matter.read', 'matter.create', 'matter.edit', 'matter.assign', 'matters.read', 'matters.write', 'work.write', 'document.read', 'document.create', 'document.share', 'invoice.view', 'invoice.create', 'invoice.send', 'billing.write', 'report.view', 'report.export', 'reports.read', 'ai.use', 'ai.client', 'ai.matter', 'ai.invoice', 'ai.document', 'ai.court', 'ai.research', 'ai.dashboard'],
  },
  {
    key: 'billing_assistant',
    name: 'Billing Assistant',
    status: 'active',
    permissionKeys: ['workspace.read', 'client.read', 'clients.read', 'invoice.view', 'invoice.create', 'invoice.send', 'payment.record', 'billing.write', 'finance.read', 'finance.write', 'report.view', 'report.export', 'report.manage', 'reports.read', 'ai.use', 'ai.invoice', 'ai.dashboard'],
  },
  {
    key: 'accountant',
    name: 'Accountant',
    status: 'active',
    permissionKeys: ['workspace.read', 'document.read', 'invoice.view', 'payment.record', 'finance.read', 'report.view', 'report.export', 'report.manage', 'reports.read', 'ai.use', 'ai.invoice', 'ai.dashboard'],
  },
];
...
export const CORE_PLANS = [
  ...
  },
  {
    ...
    name: 'Solo',
    status: 'active',
    featureKeys: ['workspace.core', 'legal.clients', 'legal.matters', 'work.capture', 'billing.core', 'reports.core', 'settings.core', 'document.storage', 'ai.assistant', 'ai.dashboard_assist', 'ai.client_assist', 'ai.invoice_assist'],
  ...
  },
  {
    ...
    name: 'Professional',
    status: 'active',
    featureKeys: ['workspace.core', 'workspace.members', 'legal.clients', 'legal.matters', 'work.capture', 'billing.core', 'finance.core', 'reports.core', 'settings.core', 'document.storage', 'ai.assistant', 'ai.dashboard_assist', 'ai.client_assist', 'ai.invoice_assist', 'ai.document_assist'],
  ...
  },
  {
    ...
    name: 'Business',
    status: 'active',
    featureKeys: ['workspace.core', 'workspace.members', 'legal.clients', 'legal.matters', 'work.capture', 'billing.core', 'finance.core', 'reports.core', 'settings.core', 'document.storage', 'ai.assistant', 'ai.dashboard_assist', 'ai.client_assist', 'ai.matter_assist', 'ai.invoice_assist', 'ai.document_assist', 'ai.court_assist', 'ai.research_assist', 'ai.matter_qna', 'integrations.zoho', 'court.sync', 'analytics.insights'],
