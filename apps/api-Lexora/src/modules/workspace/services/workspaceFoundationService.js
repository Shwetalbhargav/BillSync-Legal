...
export const CORE_ROLES = [
  ...
  },
  {
    ...
    name: 'Lawyer',
    status: 'active',
    permissionKeys: ['workspace.read', 'client.read', 'client.create', 'client.edit', 'client.delete', 'clients.read', 'clients.write', 'matter.read', 'matter.create', 'matter.edit', 'matter.assign', 'matters.read', 'matters.write', 'work.write', 'billing.write'],
  },
  {
    key: 'billing_assistant',
    name: 'Billing Assistant',
    status: 'active',
    permissionKeys: ['workspace.read', 'client.read', 'clients.read', 'billing.write', 'finance.read', 'finance.write', 'reports.read'],
  },
  {
    key: 'accountant',
    name: 'Accountant',
