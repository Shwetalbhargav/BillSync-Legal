...
export function MatterAssignmentsPage() {
  ...
  async function load() {
    ...
    try {
      ...
      setState({ status: "error", assignments: [], users: [], matters: [], message: error?.userMessage || "We could not load matter assignments right now." });
    }
  }
  ...
  async function handleAssign(event) {
    ...
    try {
      ...
      setState((current) => ({ ...current, status: "ready", message: error?.userMessage || "We could not save this assignment right now." }));
    }
  }
